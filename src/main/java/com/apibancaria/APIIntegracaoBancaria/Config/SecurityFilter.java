...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        String authorizatinoHeader = request.getHeader("Authorization");

        if (Strings.isNotEmpty(authorizatinoHeader) && authorizatinoHeader.startsWith("Bearer ")) {
            String token = authorizatinoHeader.substring("Bearer ".length());
